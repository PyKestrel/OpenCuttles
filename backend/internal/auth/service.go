...
func PermissionsForRole(role string) []string {
	...
	case domain.RoleAdmin:
		return []string{domain.PermissionAdmin, domain.PermissionOperate, domain.PermissionOpenConsole, domain.PermissionView}
	case domain.RoleOperator:
		return []string{domain.PermissionOperate, domain.PermissionOpenConsole, domain.PermissionView}
	default:
